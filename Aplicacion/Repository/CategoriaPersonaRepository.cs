...
{
    public class CategoriaPersonaRepository : Generic<CategoriaPersona>, ICategoriaPersona
    {
        private readonly PushContext _context;
        public CategoriaPersonaRepository(PushContext context) : base(context)
        {
            _context = context;
        }
        ...
        {
            var query = _context.CategoriaPersonas.AsQueryable();
