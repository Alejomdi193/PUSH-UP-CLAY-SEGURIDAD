...
{
    public class ContactoPersonaRepository : Generic<ContactoPersona>, IContactoPersona
    {
        public readonly PushContext _context;
        public ContactoPersonaRepository(PushContext context) : base(context)
        {
            _context = context;
        }
        ...
        {
            var query = _context.ContactoPersonas.AsQueryable();
